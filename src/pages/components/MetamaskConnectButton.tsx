 ...
 * 1. a button that connects to Metamask
 * 2. a button with the current address when connected and disconnects when clicked
 * 3. text that tells the user to install Metamask
 */
